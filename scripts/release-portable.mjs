...
const portableReadme = `QuickVideoMaker ${packageJson.version}\r\n\r\n` +
  ...
  "8. 必要なら［ウォーターマーク］で画像を選びます。画像はすぐ動画上へ表示され、位置、透過、間隔、角度、個数をリアルタイム調整できます。\r\n" +
  "9. 開始・終了時間と元の音声（0～100）を指定します。\r\n" +
  "10. 必要なら元音声を削除し、新しい音声とループ設定を選びます。\r\n" +
  "11. ［メタデータ管理］を開き、確認または編集します。空欄項目は削除扱いです。\r\n" +
  "12. ［設定をプレビュー］で仕上がりを確認します。\r\n" +
  "13. ［ダウンロード］を押して保存先を選ぶと、H.264/AACのMP4として保存されます。\r\n\r\n" +
  "アプリのデータ\r\n" +
